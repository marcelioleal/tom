...
public class AuthorshipFullGraphView extends Display {
...
//    MainWindow main = null;
    ...
    public AuthorshipFullGraphView(){//MainWindow main) {
...
//        super(new Visualization());
    public JPanel radialGraphView(Graph g, String label) {
        ...
        int palette[] = new int[] {
        		...
        		ColorLib.rgb(255, 255, 255),ColorLib.rgb(255, 255, 255),
        		ColorLib.rgb(255, 255, 255),ColorLib.rgb(255, 255, 255),
        		ColorLib.rgb(255, 255, 255),ColorLib.rgb(255, 255, 255)
...
//        m_vis.putAction("textColor", textColor);
        ...
        RadialTreeLayout treeLayout = new RadialTreeLayout(tree); //organiza em forma de árvore
//        treeLayout.setAngularBounds(-Math.PI/2, Math.PI);
        ...
        filter.add(new TreeRootAction(tree)); //centraliza o nó
        filter.add(fonts);
        filter.add(treeLayout); //organiza em forma de árvore
        ...
        animate.add(new VisibilityAnimator(tree)); //faz a animação ser "passo a passo"
        animate.add(new PolarLocationAnimator(treeNodes, linear)); //faz a animação ser "passo a passo"
...
//        addControlListener(new ToolTipControl("name"));
        ...
        search.addTupleSetListener(new TupleSetListener() {
            public void tupleSetChanged(TupleSet t, Tuple[] add, Tuple[] rem) {
                ...
                m_vis.cancel("animatePaint"); //permite marcar mais de um nó
                m_vis.run("recolor"); //pinta o nó q corresponde a busca
                m_vis.run("animatePaint"); //pinta o nó q corresponde a busca
            }
        });
