package org.tom.GUI.visualization.prefuse;
...
public class TreeView extends Display {
	 ...
	 * 
	 */
	private static final long serialVersionUID = -694122796114133563L;

	public static final String TREE_CHI = "tree.xml";//"/chi-ontology.xml.gz";
    ...
    public TreeView(RequirementsEvolution re){
    	width = re.width; 
    	height = re.height;
    ...
    public TreeView(Tree t, String label) {
        ...
        m_nodeRenderer = new LabelRenderer(m_label, "img");
        ...
        this.addControlListener(new ControlAdapter() {
            public void itemEntered(VisualItem item, MouseEvent e) {
                if ( item.canGetString("name") ){
                	String artifact = item.getString("artifact");

                	StringBuffer tooltipText = new StringBuffer();
                	tooltipText.append("<html>");
                	tooltipText.append(artifact);
                	tooltipText.append("</html>");
...
//    	super.repaint();
//    	setSize(width, height);
//    	System.out.println("aa: " + width + ", " + height);
//    }
...
//            label = argv[1];
//        }
//        JComponent treeview = demo(infile, label, new JPanel());
//        
...
//    }
    ...
    static public JPanel demo(BufferedInputStream datafile, final String label) {
//    	this.graphPanel = graphPanel;
    ...
    public class OrientAction extends AbstractAction {
		 ...
		 * 
		 */
		private static final long serialVersionUID = -6047051361161660665L;
